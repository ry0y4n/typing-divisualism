<template>
  <div class="index">
    ...
    <div class="container">
      <div>
        <vue-typed-js :strings="['^2000IVISUALISM']" :type-speed="100" :show-cursor="false" @onComplete="changeFlag">
          <h1 class="title">
            D<span class="typing" />
          </h1>
        </vue-typed-js>
    ...
    <div>
      <Modal v-if="modalFlag" @changeFlag="changeFlag" @changeFlag2="changeFlag2" />
      <Modal2 v-if="modalFlag2" @changeFlag2="changeFlag2" />
    </div>
  </div>
</template>
...
export default Vue.extend({
  ...
  methods: {
    ...
    changeFlag2 () {
      this.modalFlag2 = !this.modalFlag2
    }
  }
})
</script>
